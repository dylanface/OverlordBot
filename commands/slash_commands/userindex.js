...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const banButton = new MessageActionRow()
            .addComponents(
                new MessageButton()
                    .setCustomId('banuser')
        ...
        const banConfirm = new MessageActionRow()
            .addComponents(
                new MessageButton()
        ...
        try {
            ...
            await interaction.editReply({embeds: [userInfo], components: [banButton] });
            ...
            collector.on('collect', async interaction => {
                ...
                switch (interaction.customId) {
                    ...
                    case 'banuser':
                        ...
                        await interaction.editReply({ embeds: [userInfo], components: [banConfirm] });
                    break;
